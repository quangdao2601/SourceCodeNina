                    ...
                    <div class="tab-pane fade show <?= ($k == 'vi') ? 'active' : '' ?>" id="tabs-seolang-<?= $k ?>" role="tabpanel" aria-labelledby="tabs-lang">
                        <div class="form-group">
                            <div class="label-seo">
                                ...
                                <strong class="count-seo"><span><?= strlen(utf8_decode(@$seoDB['title' . $k]?:'')) ?></span>/70 <?=kytu?></strong>
                            </div>
                        ...
                        <div class="form-group">
                            <div class="label-seo">
                                ...
                                <strong class="count-seo"><span><?= strlen(utf8_decode(@$seoDB['keywords' . $k]?:'')) ?></span>/70 <?=kytu?></strong>
                            </div>
                        ...
                        <div class="form-group">
                            <div class="label-seo">
                                ...
                                <strong class="count-seo"><span><?= strlen(utf8_decode(@$seoDB['description' . $k] ?: '')) ?></span>/160 <?=kytu?></strong>
                            </div>
