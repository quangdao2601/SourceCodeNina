<div class="row">
    <div class="<?= (!empty($news)) ? 'col-lg-9 mb-3' : 'col-lg-12' ?>">
        <div class="title-detail-main"><?= $rowDetail['name' . $lang] ?></div>
        <div class="time-main"><i class="bi bi-calendar-check-fill"></i><span class="me-2"><?= date("d/m/Y h:i A", $rowDetail['date_created']) ?></span> <i class="bi bi-eye-fill"></i> <?= $rowDetail['view'] ?> <?= luotxem ?></div>
