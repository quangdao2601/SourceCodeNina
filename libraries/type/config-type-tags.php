...
$config['tags'][$nametype]['img_type'] = '.jpg|.gif|.png|.jpeg|.gif|.webp|.WEBP';

// /* Tags tin tức */
// $nametype = "tin-tuc";
// $config['tags'][$nametype]['title_main'] = tagstintuc;
// $config['tags'][$nametype]['slug'] = true;
