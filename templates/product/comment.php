                ...
                <form id="form-comment" action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-6">
                            ...
                            <div class="form-group mb-2">
                                <label for="review-content" class="mb-2">3. Viết nhận xét của bạn vào bên dưới:</label>
                                ...
                                <div class="form-group mb-2">
                                    ...
                                    <div class="custom-file mb-2">
                                        <div class="input-group mb-2">
                                            <input type="file" class="form-control" name="review-file-video" id="review-file-video" lang="vi">
                                    ...
                                    <div class="video-config">
                                        <span class="d-inline-block me-2">Định dạng: <strong><?= implode(" | ", $config['website']['video']['extension']) ?></strong></span>
